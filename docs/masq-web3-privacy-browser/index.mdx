...
Make sure you only download the MASQ web3 browser from the official website [https://masqbrowser.com](https://masqbrowser.com) and verify the checksums for any installers here:<br />
