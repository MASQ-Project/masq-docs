...
### **There are Four modes** <a href="#there-are-four-modes" id="there-are-four-modes"></a>

## Standard Mode  <a href="#standard-mode" id="standard-mode"></a>
...
## Originate-Only Mode  <a href="#originate-only-mode" id="originate-only-mode"></a>
...
## Consume-Only Mode <a href="#consume-only-mode" id="consume-only-mode"></a>
...
## Zero-Hop Mode <a href="#zero-hop-mode" id="zero-hop-mode"></a>
